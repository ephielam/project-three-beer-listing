...
var Beer = function () {
    ...
    _createClass(Beer, [{
        key: 'add6ToPage',
        value: function add6ToPage() {
            //container is now a reference to the hmtl beers-grid div
            var container = document.getElementById('beers-grid');
            ...
            var beerPhLabel = document.createElement('p');
            beerPhLabel.className = 'beer-ph-label';
            beerPhLabel.innerText = 'pH';
            var beerPhValue = document.createElement('span');
...
document.querySelector('.beers-page').addEventListener('click', function (event) {
    ...
    var form = document.getElementById('pick-a-beer-form');
...
function changePageNum(page) {
    ...
    _axios2.default.get('https://api.punkapi.com/v2/beers?page=' + page + '&per_page=6').then(function (response) {
        ...
        try {
            for (var _iterator = beerray[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var eachBeer = _step.value;

                var beer = buildBeer(eachBeer);
...
function buildBeer(eachBeer) {
    ...
    var name = eachBeer.name;
    var desc = eachBeer.description;
    var tag = eachBeer.tagline;
    var img = eachBeer.image_url;
    var abv = eachBeer.abv;
    var ibu = eachBeer.ibu;
    var ph = eachBeer.ph;
    //use imported Beer class
    var beer = new _beer2.default(name, desc, tag, img, abv, ibu, ph);
...
function quickFind() {
    ...
    _axios2.default.get('https://api.punkapi.com/v2/beers/random').then(function (response) {
        ...
        var beerobject = response.data[0];
        ...
        var beerTag = document.createElement('h3');
        ...
        ingredientsButton.addEventListener('click', function (event) {
            ...
            var beerMalt = document.createElement('span');
            beerMalt.className = 'beer-malt';
            beerMalt.innerText = '';
            var ingredients = beerobject.ingredients;
            var m = ingredients.malt[0];
            ...
            var beerHops = document.createElement('span');
            beerHops.className = 'beer-hops';
            var h = ingredients.hops[0];
            ...
            var beerYeast = document.createElement('span');
...
var findBeer = document.getElementById('find-beer');
findBeer.addEventListener('click', function () {
    alert('                           \u2229\n\u3000\u3000\u3000\u3000\u3000\u3000  \u3000\uFF3C\uFF3C\n\u3000\u3000\u3000\u3000\u3000\u3000     \uFF0F\u3000 \uFF09\n\u2282\uFF3C\uFF3F\uFF0F\uFFE3\uFFE3\uFFE3\u3000  \uFF0F      Sorry,\n\u3000\uFF3C\uFF3F\uFF0F  \xB0 \u035C\u0296 \xB0  \uFF08     I haven\'t\n\u3000\u3000 \uFF09\u3000     \u3000 \uFF0F\u2312\uFF3C    worked out\n\u3000\u3000\uFF0F\u3000 \uFF3F\uFF3F\uFF3F \uFF0F\u2312\uFF3C \u2283    how to do\n\u3000\uFF08\u3000 \uFF0F                         this yet! \n\u3000 \u3000\uFF3C\uFF3C\n           U');
});
